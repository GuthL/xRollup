...
import { sendTransferToSidechain } from '../Rollup/rpc'
import signer from '../Rollup/signer'
    ...
    if(this.state.canSend){
      ...
      if(!ERC20TOKEN && parseFloat(this.props.balance) <= 0){
        ...
        if(!this.props.isRollupEnabled) {
          ...
          const payload = signer(this.state.toAddress, this.state.amount)
          console.log(payload)
          sendTransferToSidechain(payload)
        }
      }
    }else{
